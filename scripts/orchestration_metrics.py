...
DETERMINISTIC_ACTIONS = {
    ...
    "RECLASSIFY_ACCEPTANCE_AUTHORING",
...
ADAPTER_ACTIONS = {
    "COLLECT_OBSERVED_PHASE_RESULTS",
    "OBSERVE_ACTIVE_PHASES",
    "ANNOUNCE_HUMAN_GATE",
    ...
    "RECORD_ANALYSIS_ROUTE_VALIDATION_RESULT",
    "RECORD_ANALYSIS_READINESS_RECONCILIATION",
    ...
    "RECORD_PLAN_CONTRACT_VALIDATION_RESULT",
    "RECORD_TRIAGE_RESULTS",
    "REPLACE_MODEL_WAKING_WATCHER",
    "REOPEN_STALE_PHASE_INPUT_GATE",
